...
<!--  Registro de usuario normal. Aqui no se visualiza la tabla.
Funciona de la misma manera que el otro registro solo que se omite la tabla y se utiliza el archivo BDregistro2  -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<table class="table1" cellspacing="0" cellpadding="0"
    ...
    ?>
    <form class = "formulario" action="BDregistro2.php" method ="post" style="margin-top: -0.0%; background-color:white;">
            ...
            <div class="input-contenedor">
                ...
                <div class="input-contenedor">
                    ...
                    <div class="input-contenedor">
                        ...
                        <input type="submit" value="Registrar" class="boton" name="registrar2" id="registrar2">

                        <p style="font-size: large; font-weight: bold;">Al registrarte, aceptas nuestras Condiciones de uso y Politica de provacidad</p>
                        <p style= "font-size: large; font-weight: bold; ">Ya tienes cuenta? <a class="link" href="login.php">Iniciar Sesion</a></p>
